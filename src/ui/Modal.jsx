...
const Window = ({ children, name }) => {
  ...
  return createPortal(
    <OverLay>
      <div
        ref={ref}
        className="bg-white rounded-md py-4 px-6 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-md z-50 transistion duration-300 ease-in-out"
      >
